...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'first_name', 'last_name', 'status', 'role_id', 'country_id', 'state_id', 'city_id', 'zip_code', 'service_id', 'otp', 'status', 'email', 'password', 'contact_mode', 'contact_number', 'profile_picture'
    ];
